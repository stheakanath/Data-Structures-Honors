...
/**
   Testing out doublely linked lists. Fun!
*/
    ...
    public static void exercise_2_6_1() {
       ...
       Node bill = new Node<String>("Bill");   
        ...
        tail.prev = sue;
		  ...
		  while( temp != null ) {
            String currentdata,nextdata,prevdata;
            if(temp != null)
            ...
            if(temp.prev != null)
               ...
               prevdata = "null";
				...
				System.out.println("   data: " + currentdata + " next:" + nextdata + " prev:" + prevdata);
				temp = temp.next;
		  }
        ...
        tail.next = null;
		  ...
		  System.out.print("\nPrinting out list after removals ");
		  temp = head;
		  while( temp != null ) {
            String currentdata,nextdata,prevdata;
            if(temp != null)
...
public class KWLinkedListTest_Theakanath {
